			...
			{showStats && !duel && tiles.length > 0 && (
				<div style={styles.statsPanel}>
					<div style={styles.statPlayer}>
						<div
							style={{ ...styles.statDot, background: players[0].color, boxShadow: `0 0 8px ${players[0].color}` }}
						/>
					...
					<div style={{ ...styles.statPlayer, flexDirection: 'row-reverse' }}>
						<div
							style={{ ...styles.statDot, background: players[1].color, boxShadow: `0 0 8px ${players[1].color}` }}
						/>
