...
export default function DuelModal() {
  ...
  useEffect(() => {
    ...
    const handler = (e: KeyboardEvent) => {
      ...
      switch (e.key) {
        case 'a': case 'A':
          e.preventDefault(); handleCorrect(1); break
        case 'd': case 'D':
          e.preventDefault(); handleCorrect(2); break
        case 'p': case 'P': case ' ':
          e.preventDefault(); handlePass(); break
        case 'Escape':
  ...
  const timerColor = (t: number) =>
    t <= 5 ? '#ef4444' : t <= 15 ? '#facc15' : '#ffffff'
            ...
            <div
              ...
              <div
                style={{
                  ...
                  border: `1px solid ${feedback.text
                    ? feedback.type === 'correct'
                      ? 'rgba(34,197,94,0.4)'
                      : feedback.type === 'pass'
                        ? 'rgba(251,146,60,0.4)'
